 ...
 */
	...
	public Vehicle[][] vehicleArray = {
			...
			{new Vehicle (640.0, 352.0, 0.75, 1, false), new Vehicle (512.0, 352.0, 0.75, 1, false), new Vehicle (384.0, 352.0, 0.75, 1, false),
				new Vehicle (256.0, 352.0, 0.75, 1, false), new Vehicle (128.0, 352.0, 0.75, 1, false)},
			...
			//Left-bound vehicle @ y = 	288.0, traveling at speed of 0.5, gaps of 160, and length of 2:
			{new Vehicle (640.0, 288.0, 0.5, 2, false), new Vehicle (480, 288.0, 0.5, 2, false), new Vehicle (320, 288.0, 0.5, 2, false),
				new Vehicle (160, 288.0, 0.5, 2, false)}
	};
	...
	public Turtle[][] turtleArray = {
			...
			{new Turtle (640.0, 224.0, 1.5, 3), new Turtle (448.0, 224.0, 1.5, 2), new Turtle (320.0, 224.0, 1.5, 3),
					new Turtle (192.0, 224.0, 1.5, 2), new Turtle (64, 224.0, 1.5, 2)}
	};
